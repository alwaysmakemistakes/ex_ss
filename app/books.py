...
from app import db
from models import Book, Category, User, Review
...
def calc_book_rating(book_id):
    # Получаем объект курса из базы данных по указанному идентификатору book_id
...
def show(book_id):
    ...
    return render_template('books/show.html', book=book, reviews_all=reviews_all, reviews_lim5=reviews_lim5, users=users, flag=flag, book_id=book_id, book_rating=book_rating)
